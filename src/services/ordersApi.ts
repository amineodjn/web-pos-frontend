 ...
 */
export const fetchOrdersApi = async (query: UseOrdersQuery): Promise<OrderApiResponse> => {
 ...
 * @returns Promise<OrderApiResponse>
 */
export const createOrderApi = async (order: OrderCreateRequest): Promise<OrderApiResponse> => {
 ...
 * @returns Promise<OrderApiResponse>
 */
export const updateOrderApi = async (order: OrderUpdateRequest): Promise<OrderApiResponse> => {
  const url = buildApiUrl('orders');
 ...
 */
export const deleteOrderApi = async (order: OrderDeleteRequest): Promise<void> => {
  const url = buildApiUrl('orders');
  await fetchApi<OrderDeleteRequest, void>(url, {
    method: 'DELETE',
    body: order,
  });
};
