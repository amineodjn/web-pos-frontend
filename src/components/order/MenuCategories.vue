<template>
  <div class="bg-white dark:bg-dark-bg rounded-lg shadow p-6">
    <div class="mb-4">
      <CategoryNavigation v-model="selectedCategory" :categories="menuStore.categories" />
      <!-- Menu Categories -->
      <div
...
<script setup lang="ts">
  ...
  const selectedCategoryItems = computed(() => {
    ...
    const category = menuStore.categories.find(c => c.categoryName === selectedCategory.value);
